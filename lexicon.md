...
| Urh | evil / damned / accursed / morally corrupted |
| Ma | large |
| Na | small |
| Mar | eternal |
| Nar | never |
...
- `Niē` distinguishes physical vs spiritual elevation
...
| AhNahl | institutional king / royal office / kingdom |
| NiAhNah / NiēAhNa | priest / saint |
...
is intentional and resolved contextually.

Calling one’s spouse:
- `UrhNah`
- `UrhNahi`
...
Love is fundamentally understood as:
> righteous action, not merely emotion.
